...
const UpdateSingleFare = (props) => {
    ...
    async function getFareDetails() {
        const det = await fetch(`http://localhost:5000/fares/getsinglefare/${props.match.params.id}`);
    ...
    const onSubmitForm = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:5000/fares/update/${props.match.params.id}`, {
                method: "PUT",
