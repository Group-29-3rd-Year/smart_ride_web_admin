...
const UpdateSingleConductor = (props) => {
    ...
    async function getBusses() {
        const res = await fetch("https://smartride-backend.herokuapp.com/admin/conductors/getbusses");
    ...
    async function getConDetails() {
        const det = await fetch(`https://smartride-backend.herokuapp.com/admin/conductors/getsinglecon/${props.match.params.id}`);
    ...
    const onSubmitForm = async (e) => {
        ...
        try {
            ...
            const body = {busNo};
            console.log(busNo);
            const response = await fetch(`https://smartride-backend.herokuapp.com/admin/conductors/update/${props.match.params.id}`, {
                method: "PUT",
